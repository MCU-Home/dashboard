...
| [0003](0003-two-home-assistant-apps-dashboard-never-compiles.md) | Two Home Assistant Apps; the dashboard never compiles | accepted |
...
| [0006](0006-build-service-protocol.md) | The build-service protocol | accepted |
